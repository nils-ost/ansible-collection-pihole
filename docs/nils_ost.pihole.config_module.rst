.. _nils_ost.pihole.config_module:
...
**read or write PiHole config key**
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>which part of the config to handle (sections are separated by /)</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>the value that the element should get</div>
                </td>
            </tr>
    </table>
    <br/>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>always</td>
                <td>
                            <div>value of requested key, or value the key was set to</div>
                    <br/>
                </td>
            </tr>
    </table>
